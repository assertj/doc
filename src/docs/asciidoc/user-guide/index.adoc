...
- Add syntax sugar link:#assertj-core-3.14.0-instance-of-assert-factories-as[`as(InstanceOfAssertFactory)`] to improve readability. (Stefano Cordio)
...
[[assertj-core-3.14.0-instance-of-assert-factories-as]]
[.release-note-item]#Add syntax sugar `as(InstanceOfAssertFactory)` to improve readability#
