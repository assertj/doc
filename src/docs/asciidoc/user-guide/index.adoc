...
WARNING: This removes previously supported assertions for `Iterable`, call http://joel-costigliola.github.io/assertj/core-8/api/org/assertj/core/api/AbstractIteratorAssert.html#toIterable--[`IteratorAssert#toIterable`] to access iterable assertions, ex:
