...
Thanks to all the contributors of this release: Erhard Pointl, Stefano Cordio, Jonas Berlin, Thami Inaflas, Geoffrey Arthaud,  Kevin Toublanc,
...
- Fix a few javadoc typos. (Erhard Pointl)
