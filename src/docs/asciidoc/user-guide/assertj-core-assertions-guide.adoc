...
* different way to link:#assertj-core-group-contains[check what the iterable/array contains] to check it
...
* link:#assertj-core-group-satisfy[verify some assertions on elements (any, all, none)]
