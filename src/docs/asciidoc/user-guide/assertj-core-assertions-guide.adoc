...
* an element mactching a link:#filtering-with-a-condition[Condition] 
...
Let's say you have called some service and got a list (or an array) of `TolkienCharacter`, to check the results you have to build the expected TolkienCharacters, that can be a lot of work!
