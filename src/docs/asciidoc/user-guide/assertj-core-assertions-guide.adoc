...
* Different ways of link:#assertj-core-group-contains[checking the iterable/array content]
* link:#assertj-core-group-satisfy[Verify assertions on some elements (any, all, none)]
...
===== Different ways of checking the iterable/array content
