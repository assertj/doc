...
In addition to specific type assertions, each type inherits assertions from https://www.javadoc.io/doc/org.assertj/assertj-core/latest/org/assertj/core/api/AbstractAssert.html[`org.assertj.core.api.AbstractAssert`].
