...
The release [red]#is not binary compatible# with the previous version. Full report: icon:file-text[link=reports/assertj-core/3.20.0/japicmp.html, window=_blank]
...
The release [red]#is not binary compatible# with the previous version. Full report: icon:file-text[link=reports/assertj-core/3.19.0/japicmp.html, window=_blank]
...
The release [red]#is not binary compatible# with the previous version. Full report: icon:file-text[link=reports/assertj-core/3.18.0/japicmp.html, window=_blank]
...
The release [red]#is not binary compatible# with the previous version. Full report: icon:file-text[link=reports/assertj-core/3.17.0/japicmp.html, window=_blank]
