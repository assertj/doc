...
Thanks to all the contributors of this release: Erhard Pointl, Stefano Cordio, Yusuke Mukai, Martin Tarjányi, Trang Nguyen, jbock, Annette0127, Zihan Xu, Ashley Scopes, Benjamin Ze'ev Tels, Ahmad Sadeed, temp-droid, Ilya Koshaleu, Spacca and Erik Pragt.
