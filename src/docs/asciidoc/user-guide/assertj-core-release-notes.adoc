...
* Add `isUnmodifiable` to `Map` assertions (#2458). (Wojciech Zankowski)
* Add `isExecutable` to `File` assertions (#2829). (Rostyslav Ivankiv)
...
* Add baseline for `ClassLoader` assertions (#2645) (Ashley Scopes)
...
* Internal: Bump Bnd version to 6.3.1
* Internal: Bump byte-buddy version in `verify.bndrun` (Erhard Pointl)
* Internal: Bump byte-buddy.version from 1.12.10 to 1.12.19
* Internal: Bump cdg.pitest.version from 0.2.0 to 1.0.1
* Internal: Bump equalsverifier from 3.10 to 3.11.1
* Internal: Bump gmavenplus-plugin from 1.13.1 to 2.1.0
* Internal: Bump groovy from 4.0.4 to 4.0.6
* Internal: Bump hibernate-core from 6.0.2.Final to 6.1.5.Final
* Internal: Bump jackson-databind from 2.13.3 to 2.14.0
* Internal: Bump japicmp-maven-plugin from 0.15.7 to 0.17.1
* Internal: Bump junit-jupiter-api from 5.8.2 to 5.9.1
* Internal: Bump junit-pioneer from 1.7.1 to 1.9.0
* Internal: Bump kotlin.version from 1.7.10 to 1.7.21
...
* Internal: Bump Mockito to version 4.6.1 (Erhard Pointl)
* Internal: Bump mockito-bom from 4.6.1 to 4.9.0
* Internal: Bump org.eclipse.osgi from 3.17.200 to 3.18.100
* Internal: Bump pitest from 1.9.2 to 1.9.4
* Internal: Bump pitest-junit5-plugin from 0.15 to 1.1.0
* Internal: Bump pitest-maven from 1.8.0 to 1.9.11
* Internal: Bump spotbugs-maven-plugin from 4.7.1.1 to 4.7.3.0
* Internal: Bump spring-core from 5.3.20 to 5.3.24
* Internal: Bump versions-maven-plugin from 2.11.0 to 2.13.0
...
For example if the specified compared fields of types = {String.class, Integer.class, Double.class}, when there are fields String foo, Integer buzz and Double bar and the ignored fields = {"bar"} set with ignoringFields(String...) that will remove bar field from comparison, then only {foo, baz} fields will be compared.
...
Building block to define more precise condition on complex objects. It allows to create readable assertions and produces beautiful assertion error messages.
