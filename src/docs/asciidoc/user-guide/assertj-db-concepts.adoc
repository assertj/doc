...
There are examples of the navigation in https://github.com/joel-costigliola/assertj-examples/blob/master/assertions-examples/src/test/java/org/assertj/examples/db/NavigationExamples.java[NavigationExamples.java]
...
image::db-navigation-with-table-or-request.png[]
...
image::db-navigation-with-changes.png[]
