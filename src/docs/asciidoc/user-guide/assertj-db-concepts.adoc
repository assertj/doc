...
** <<assertj-db-concepts-assertdbconnectionlettercase, LetterCase setup>> [.small]#(since <<assertj-db-3-0-0-release-notes,3.0.0>>)#
** <<assertj-db-concepts-assertdbconnectionmetadata, Schema retrieval mode>> [.small]#(since <<assertj-db-3-0-0-release-notes,3.0.0>>)#
...
[[assertj-db-concepts-assertdbconnectionlettercase]]
===== LetterCase setup
...
[[assertj-db-concepts-assertdbconnectionmetadata]]
===== Schema retrieval mode

Since <<assertj-db-1-1-0-release-notes,3.0.0>>
...
There are examples of the navigation in {assertj-examples-github}/blob/main/assertions-examples/src/test/java/org/assertj/examples/db/NavigationExamples.java[NavigationExamples.java]
