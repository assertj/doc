...
Note that you can find more working examples in the assertj-examples project: {assertj-examples-github}/tree/main/assertions-examples/src/test/java/org/assertj/examples/guava.
